/**
 * Config trung tâm — đọc tất cả VITE_ env vars và export ra constants
 * Các file khác chỉ cần import từ đây, không đọc import.meta.env trực tiếp
 */

/** Helper parse số nguyên từ env, trả về fallback nếu không hợp lệ */
...
// ------- Socket.IO -------
export const SOCKET_RECONNECT_ATTEMPTS = envInt(import.meta.env.VITE_SOCKET_RECONNECT_ATTEMPTS, 5);
export const SOCKET_RECONNECT_DELAY = envInt(import.meta.env.VITE_SOCKET_RECONNECT_DELAY, 2000);

// ------- File Manager -------
export const FILE_DEFAULT_PATH = import.meta.env.VITE_FILE_DEFAULT_PATH || 'C:/Innotech';
...
export const HISTORY_MAX_POINTS = envInt(import.meta.env.VITE_HISTORY_MAX_POINTS, 60);
